...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  DO $$ BEGIN
   CREATE TYPE "public"."enum_projects_fetch_status" AS ENUM('NOT_FETCHED', 'FETCHED', 'ERROR');
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE TABLE IF NOT EXISTS "projects" (
  	...
  	"thumbnail_id" uuid,
  	"created_by" varchar,
  	"fetch_status" "enum_projects_fetch_status" DEFAULT 'NOT_FETCHED',
  	"slug" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "projects_rels" ADD CONSTRAINT "projects_rels_projects_categories_fk" FOREIGN KEY ("projects_categories_id") REFERENCES "public"."projects_categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "posts_rels" ADD CONSTRAINT "posts_rels_posts_tags_fk" FOREIGN KEY ("posts_tags_id") REFERENCES "public"."posts_tags"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_projects_categories_fk" FOREIGN KEY ("projects_categories_id") REFERENCES "public"."projects_categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_posts_tags_fk" FOREIGN KEY ("posts_tags_id") REFERENCES "public"."posts_tags"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "projects_categories_created_at_idx" ON "projects_categories" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "posts_created_at_idx" ON "posts" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "posts_rels_order_idx" ON "posts_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "posts_rels_parent_idx" ON "posts_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "posts_rels_path_idx" ON "posts_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "posts_tags_created_at_idx" ON "posts_tags" USING btree ("created_at");
